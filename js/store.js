...
StoreApp.View.ShoppingCart = Backbone.View.extend({
	...
	defaultMessage : function() {
		...
		this.$el.addClass('empty').html('<tr><td colspan="4"><i class="fa fa-shopping-cart"></i> Keranjang masih kosong</td></tr>');
...
var items = [
	{ id:'1',title: 'Ayam Bakar', thumb:'img/thumb/1.jpg',image:'img/1.jpg',price: 20000, photographer:'Bob',tag:'myTag',description:'Et mea prima verterem. Has eu eligendi facilisi. Cu graece populo eos, cum suas contentiones ne, nam sanctus dolorem efficiendi id. Ei invidunt dignissim temporibus has, ea usu iudicabit erroribus mediocritatem, nec sanctus eligendi delicata ex. An detraxit incorrupte vituperatoribus nec, ad vim vide altera suscipiantur. Cu has vitae expetenda, est congue instructior no, qui scripta utroque voluptaria no. Te senserit deterruisset mea, mel primis electram splendide ea. Ipsum percipitur philosophia usu ad. Has quod fierent contentiones ei, eos id dicat iracundia, vis falli soleat dicunt cu. Nam et congue oblique.' },
	{ id:'2',title: 'Nila Asam Manis', thumb:'img/thumb/2.jpg',image:'img/2.jpg',price: 20000, photographer:'Paolo',tag:'myTag',description:'Vidit audire in sed, id mei cetero impedit neglegentur, eripuit fierent patrioque ut usu. Saepe semper ut qui, cu saepe scaevola ius? In quo prima vidisse elaboraret. Est id latine facilis sententiae, sensibus definitionem no sit. An vidisse scribentur has, ei vel qualisque aliquando? Vero vide vidit in eos.' },
	{ id:'3',title: 'Nila Bakar', thumb:'img/thumb/3.jpg',image:'img/3.jpg', price: 20000, photographer:'Michele',tag:'myTag',description:'Causae complectitur in sed, petentium reprehendunt sit ut! Falli delicata mel ex, amet lorem eum cu. Sit at forensibus concludaturque. Usu iusto tractatos et? Eligendi delectus no mei. Ea habeo facilis qui, lorem mollis scripta ut duo. Noster ponderum vituperata ea usu. Vero vide vidit in eos, ei mentitum periculis his? Quo mazim decore philosophia ea, ad mei harum albucius, malorum comprehensam conclusionemque cu duo. Dicam everti has in, sea ea alia probo dicat!' },
	{ id:'4',title: 'Udang', thumb:'img/thumb/4.jpg',image:'img/4.jpg', price: 20000, photographer:'Ettore',tag:'myTag',description:'Cu pri nonumy latine? Ei probatus deserunt est. Tacimates prodesset gloriatur mei at. Quidam scribentur ex per. Eum accumsan maiestatis accommodare cu, usu alterum delenit et. Platonem philosophia vix te, sed cu alterum vivendum nominati. Justo commune argumentum an nam, at sonet tantas graecis mea. Vim eu omittam interesset definitiones! Ut quo mucius dissentiunt accommodare. Cu postea equidem habemus sit, sea ad erat movet, ancillae copiosae an est?' },
	{ id:'5',title: 'Passion', thumb:'img/thumb/5.jpg',image:'img/5.jpg', price : 20000, photographer:'paolo',tag:'myTag',description:'Vidit audire in sed, id mei cetero impedit neglegentur, eripuit fierent patrioque ut usu. Saepe semper ut qui, cu saepe scaevola ius? In quo prima vidisse elaboraret. Est id latine facilis sententiae, sensibus definitionem no sit. An vidisse scribentur has, ei vel qualisque aliquando? Vero vide vidit in eos.' },
	{ id:'6',title: 'Map', thumb:'img/thumb/6.jpg',image:'img/6.jpg', price : 20000, photographer:'Bob',tag:'myTag',description:'Vidit audire in sed, id mei cetero impedit neglegentur, eripuit fierent patrioque ut usu. Saepe semper ut qui, cu saepe scaevola ius? In quo prima vidisse elaboraret. Est id latine facilis sententiae, sensibus definitionem no sit. An vidisse scribentur has, ei vel qualisque aliquando? Vero vide vidit in eos.' },
